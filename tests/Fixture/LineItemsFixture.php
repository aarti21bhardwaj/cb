...
class LineItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'addon_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-11-21 14:18:52',
                'modified' => '2018-11-21 14:18:52'
            ],
        ];
        parent::init();
    }
