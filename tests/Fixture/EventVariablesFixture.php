...
/**
 * EventVariablesFixture
 *
 */
class EventVariablesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'variable_key' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
