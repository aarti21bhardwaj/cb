...
/**
 * InstructorInsuranceFormFixture
 *
 */
class InstructorInsuranceFormFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'instructor_insurance_form';
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date' => '2018-09-27',
                'created' => '2018-09-27 08:35:40',
                'modified' => '2018-09-27 08:35:40'
            ],
        ];
        parent::init();
    }
