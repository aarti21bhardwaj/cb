...
/**
 * StudentPromoCodesFixture
 *
 */
class StudentPromoCodesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'applied_by' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'student_id' => 1,
                'promo_code_id' => 1,
                'created' => '2019-01-03 13:33:45',
                'modified' => '2019-01-03 13:33:45',
                'applied_by' => 'Lorem ipsum dolor sit amet',
                'course_id' => 1
            ],
        ];
        parent::init();
