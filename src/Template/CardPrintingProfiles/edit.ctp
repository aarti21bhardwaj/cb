...
<div class="cardPrintingProfiles form large-9 medium-8 columns content">
    ...
    <div class = 'ibox-title'>
        <legend><?= __('Edit Card Printing Profile') ?></legend>
    </div>
        <?php
           echo $this->Form->control('name', ['required', 'type'=>'text', 'data-validation'=>'alphanumeric', 'data-validation-allowing' =>'-_ ']); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?= $this->Form->control('card_printing_profile_training_sites',['label' => false,'options'=> $trainingSites,'class'=>['select2_demo_2','form-control'], 'multiple' => true])?>
                </div>
            </div>

            <?php echo $this->Form->control('left_right_adjustment',[ 'options' =>$cardAlignment]);
            echo $this->Form->control('up_down_adjustment',[ 'options' =>$cardAlignment]);
