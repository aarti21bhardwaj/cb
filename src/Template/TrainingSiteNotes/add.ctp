                ...
                <div class="trainingSiteNotes form large-9 medium-8 columns content">
                    ...
                    <fieldset>
                        <!-- <div class = 'ibox-title'> -->
                            ...
                            <legend><?= __('Add Note For ')?><?php echo $trainingSites->name;  ?></legend>
                            </div>
                        <!-- </div> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">    
                                ...
                                <div class="col-sm-10" align="center">
                                    <?= $this->Form->control('description', ['type'=> 'textarea', 'label' => false, 'class' => ['form-control', 'fr-view','col-sm-offset-1']]); ?>
                                </div>
                            </div>
                        </div>
                    </fieldset>
