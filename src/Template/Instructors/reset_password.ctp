...
<div class="passwordBox animated fadeInDown">
  <div class="row">
    ...
    <?= $this->Form->create(NULL, ['url' => ['controller' => 'Instructors', 'action' => 'resetPassword'],'data-toggle'=>"validator"]) ?>
            ...
            <?= $this->Form->control("cnf_new_pwd", array(
                    ...
                    ?>
        <button type="submit" class="btn btn-primary block full-width m-b" id='saveUserPassword'>Reset password</button>
    <?= $this->Form->end() ?>
     <div class="text-center">
          <strong><a href="<?= $this->Url->build(['controller' => 'Instructors','action' => 'login'])?>"><small>Go Back To Login</small></a></strong><br>
