...
<div class="middle-box text-center loginscreen animated fadeInDown">
    <div>
        <?php 
            ...
            <?php }?>
        <h3>Welcome to <?php echo $tenantData->center_name."'s Instructor Portal";?></h3>
        ...
        <div class="row">
            <div class="text-center">
                <strong><a href="<?= $this->Url->build(['controller' => 'Instructors','action' => 'forgotPassword'])?>"><small>Forgot password?</small></a></strong><br>
