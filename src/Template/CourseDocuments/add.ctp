		...
		<div class="ibox float-e-margins">
			<div class="ibox-content">
                <div class="courseDocuments form large-9 medium-8 columns content">
                    <?= $this->Form->create($courseDocument, ['class' => 'form-horizontal', 'enctype'=>"multipart/form-data"]) ?>
                    <fieldset>
                        <div class = 'ibox-title'>
                            <legend><?= __('Add Course Document') ?></legend>
                        </div>
                        <?php if(!$course_id){
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="img-thumbnail">
                                    <?= $this->Html->image($courseDocument->image_url, array('height' => 100, 'width' => 100,'id'=>'upload-img')); ?>
                                </div> 
                                <br> </br>
                    ...
                    <div class="col-sm-10">
                        ...
                        <?= $this->Form->control('description', ['placeholder'=>'ex.PO for client','type'=>'textarea','label' => false, 'class' => ['form-control','tinymceTextarea']]); ?>
                    </div>
                </div>
                    </fieldset>
