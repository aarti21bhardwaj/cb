...
<div class="courseTypes form large-9 medium-8 columns content">
    ...
    <div class = 'ibox-title'>
        ...
        <?php
            ...
            echo $this->Form->control('course_type_category_id', ['empty'=> '--SELECT ONE--','options' => $courseTypeCategories]);
            echo $this->Form->control('agency_id', ['empty' => '--SELECT ONE--']);

            echo $this->Form->control('name',['label' => ['text'=> 'Course Name']]);
            echo $this->Form->control('valid_for', ['empty' => '--SELECT ONE--', 'options' =>$courseDurations ]);
        ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <?= $this->Form->control('color_code', ['type'=> 'color','id' => 'full','value'=>'#ff0000' ,'label' => false]); ?>
            </div>
        </div>
