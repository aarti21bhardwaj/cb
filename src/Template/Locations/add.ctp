                ...
                <div class="locations form large-9 medium-8 columns content">
                    ...
                    <div class = 'ibox-title'>
                        ...
                        <?php
                            ...
                            echo $this->Form->control('contact_email', ['data-validation'=> "email" ,'type'=> "text",'label' => ['text'=>'Site Contact Email']], 'required');
                            ...
                            echo $this->Form->control('name', ['required', 'type'=>'text', 'data-validation'=>'text','label' => ['text'=>'Location Name']]);
