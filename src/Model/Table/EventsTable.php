 ...
 * @property \App\Model\Table\EventVariablesTable|\Cake\ORM\Association\HasMany $EventVariables
 *
...
class EventsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('event_key')
            ->maxLength('event_key', 255)
            ->requirePresence('event_key', 'create')
            ->notEmpty('event_key');

        $validator
            ->boolean('is_schedulable')
            ->requirePresence('is_schedulable', 'create')
            ->notEmpty('is_schedulable');
